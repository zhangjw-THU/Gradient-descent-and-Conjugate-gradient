function [X,Y,F,F_d] = ConjugateGradientBS(x0,y0)
    ...
    while e>eps
        if mod(count-1,n)==0
            ...
            aerph = (grad1(1)*(grad1(1)-grad0(1))+grad1(2)*(grad1(2)-grad0(2)))/(D_old(1)*(grad1(1)-grad0(1))+D_old(2)*(grad1(2)-grad0(2)));
